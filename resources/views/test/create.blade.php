...
@section('page-content')
    <div class="content">
        <div class="page-title">
            <h3>Gestione verifiche - <span class="semi-bold">Aggiungi</span></h3>
        </div>
                        ...
                        <div class="row-fluid m-t-10">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="controls">
                                        {!! Form::select('module_id', $modules->lists('name', 'id') , old('module_id') , ['class' => 'select2-wrapper', 'style' => 'width: 100%']) !!}
                                    </div>
                                </div>
